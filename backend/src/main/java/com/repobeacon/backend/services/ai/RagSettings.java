...
/**
 * Tunable defaults for retrieval and streaming.
 * Centralized here so beginners can find all AI-related magic numbers in one
 * place.
 */
public final class RagSettings {
   ...
   * {@link devPilot.backend.service.indexing.CodeChunker}).
   */
