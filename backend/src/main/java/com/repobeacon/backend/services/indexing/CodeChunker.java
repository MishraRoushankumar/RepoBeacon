...
/**
 * Splits a source file into embedding-sized chunks using Spring AI's
 * {@link TokenTextSplitter}.
 */
@Component
public class CodeChunker {
  ...
  public CodeChunker(
    ...
    // Spring AI splits by tokens; ~4 characters per token is a reasonable default
    // for code.
