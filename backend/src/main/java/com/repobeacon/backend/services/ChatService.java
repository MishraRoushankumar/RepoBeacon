...
import com.repobeacon.backend.dto.ChatSessionResponse;
import com.repobeacon.backend.dto.CreateChatSessionRequest;
import com.repobeacon.backend.entity.ChatMessage;
import com.repobeacon.backend.entity.ChatSession;
...
import com.repobeacon.backend.repository.ChatSessionRepository;
import com.repobeacon.backend.services.ai.ChatPromptBuilder;
import com.repobeacon.backend.services.ai.ChatStreamHandler;
import com.repobeacon.backend.services.ai.CitationMapper;
import com.repobeacon.backend.services.ai.CodeContextRetriever;
...
public class ChatService {
  ...
  public SseEmitter streamReply(UUID userId, UUID sessionId, String userContent) {
    ...
    var retrievedContext = codeContextRetriever.retreive(repo.getId(), userContent);
    ...
    // 5. Stream Google GenAI response to the client (SSE)
