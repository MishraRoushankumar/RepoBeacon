...
import { RepoBeaconIcon } from "@/components/icons/repobeacon-icon";
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton
                ...
                tooltip="RepoBeacon"
              >
                <RepoBeaconIcon className="size-8 rounded-[10px]" />
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">RepoBeacon</span>
